...
While it's always a good idea to keep WordPress up to date, we understand that there's times you may need to quickly revert to a previous version. This plugin makes that process as easy as clicking as a few mouse clicks. Simply select the version of WordPress that you'd like to downgrade to, confirm, and in a few moments you'll be using the version you requested. No fumbling to find the version, FTPing, or hair pulling.
